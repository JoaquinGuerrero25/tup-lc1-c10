...
void mostrarMenu();
void cargarProducto(int productos[][2], int numProductos, int cantProductos);
...
int main()
{
    ...
    {
        mostrarMenu();
        printf("Ingrese el numero de la opciin que desee: ");
        scanf("%i", &opcion);
...
void cargarProducto(int productos[][2], int numProductos, int maxProdutos)
{
    if(numProductos < maxProdutos)
    {
    ...
    {
        printf("Se alcanzo el lime de productos.\n");
    }
}
...
void modificarStock(int productos[][2], int *numProductos)
{
    if (*numProductos > 0)
    {
        ...
        for (int i = 0; i < numProductos; i++)
        {
            ...
            {
                encontrado = 1;
                printf("Producto encontrado: Codigo de Barras: %i, Stock actual: %i\n", productos[i][0], productos[i][1]);
